...
export default function ProjectsCursorGlow() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (projectsEl) {
        ...
        inSection = mouse.current.y >= r.top && mouse.current.y <= r.bottom;
      }
  ...
  return (
    <>
      <svg aria-hidden="true" style={{ display: 'none' }}>
        <defs>
          <filter id="glow-noise-projects" x="-32%" y="-32%" width="164%" height="164%">
      ...
      <div
        ...
        style={{
          ...
          pointerEvents: 'none',
          zIndex: 4,
          filter: 'url(#glow-noise-projects)',
