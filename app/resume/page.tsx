              ...
              <div className="mb-3 flex flex-col gap-3 rounded-[22px] border border-black/8 bg-[#efe9df] px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                ...
                <div className="flex flex-col items-stretch gap-3 sm:flex-row">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-[var(--border)] bg-[var(--background)]/88 px-4 py-2.5 font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--foreground)] shadow-[0_16px_40px_rgba(0,0,0,0.08)] backdrop-blur-sm transition-all duration-200 hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] sm:px-5 sm:text-xs"
                  >
                  ...
                  <a
                    href={RESUME_PATH}
                    download
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-[var(--border)] bg-[var(--card)]/92 px-4 py-2.5 font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--foreground)] shadow-[0_16px_40px_rgba(0,0,0,0.08)] backdrop-blur-sm transition-all duration-200 hover:border-[var(--color-accent)] hover:bg-[var(--color-accent-subtle)] hover:text-[var(--color-accent)] sm:px-5 sm:text-xs"
                  >
